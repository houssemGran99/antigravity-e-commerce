...
const Hero = () => {
    ...
    if (user?.isAdmin) return null; // Prevent flash of content
    return (
        <div className="relative overflow-hidden bg-background py-24 sm:py-32">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
                    <span className="block text-foreground">Capture the World</span>
                ...
                <div className="flex justify-center gap-4">
                    <Link href="/shop" className="group flex items-center gap-2 bg-primary hover:bg-blue-600 text-white px-8 py-3 rounded-full font-semibold transition-all">
                        Shop Collection
                        <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                    </Link>
                    <button className="bg-muted hover:bg-muted/80 text-foreground px-8 py-3 rounded-full font-semibold transition-all backdrop-blur-sm">
                        Learn More
                    </button>
                </div>
            </div>
