...
const Checkout = () => {
    ...
    const submitHandler = async (e) => {
        ...
        const orderData = {
            orderItems: cart.map(item => ({
                ...
                image: item.imageUrl,
                price: item.price,
                qty: 1 // Default to 1 for now as per current simple cart structure
            })),
            shippingAddress: {
                address,
                city,
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Redirect to Success/Order Details
    ...
    if (cart.length === 0) {
        return (
            <div className="min-h-screen bg-black pt-24 text-white flex flex-col items-center justify-center">
        ...
        <div className="min-h-screen bg-black pt-24 pb-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center gap-4 mb-8">
                    <Link to="/cart" className="p-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors text-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="bg-dark-800 p-8 rounded-2xl border border-white/5">
                        ...
                        <form onSubmit={submitHandler} className="space-y-6">
                            ...
                            <button type="submit" className="w-full bg-primary hover:bg-blue-600 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-primary/20 mt-8">
                                Place Order
                            </button>
                        </form>
                    </div>
                    ...
                    {/* Order Summary */}
                    <div className="bg-dark-800 p-8 rounded-2xl border border-white/5 h-fit">
                        <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
