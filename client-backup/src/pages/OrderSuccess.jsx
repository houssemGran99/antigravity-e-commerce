        ...
        <div className="min-h-screen bg-black flex items-center justify-center p-4">
            <div className="bg-dark-800 p-12 rounded-3xl border border-white/10 max-w-lg w-full text-center">
                ...
                <div className="flex flex-col gap-3">
                    <Link to="/shop" className="bg-primary hover:bg-blue-600 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-primary/20 block w-full">
                        Continue Shopping
                    </Link>
                    <Link to="/profile" className="text-gray-400 hover:text-white py-2 flex items-center justify-center gap-2 transition-colors">
